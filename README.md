This project consists of the creation of a grid where people can draw with the move of the mouse. The grid is automatically generated using DOM manipulation.
